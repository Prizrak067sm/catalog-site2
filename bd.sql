...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 28 2020 г., 00:14
...
--
CREATE DATABASE `catalog-site` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `catalog-site`;
...
INSERT INTO `category` (`id`, `genre`, `brief_description`, `full_description`, `activ`) VALUES
(1, 'Ужасы', 'Краткое описание жанра Ужасы', 'Полное описание жанра Ужасы', 1),
(2, 'Научная литература', 'Краткое описание жанра Научная литература', 'Полное описание жанра Научная литература', 1),
(3, 'Комедия', 'Краткое описание комедии', 'Полное описание комедии', 0),
(4, 'Классика', 'Краткое описание жанра Классика', 'Полное описание жанра Классика', 1),
(5, 'Фэнтези', 'Краткое описание жанра Фэнтези', 'Полное описание жанра Фэнтези', 1),
(6, 'Роман', 'Краткое описание жанра Роман', 'Полное описание жанра Роман', 2),
(7, 'Проза', 'Краткое описание жанра Проза', 'Полное описание жанра Проза', 2),
(8, 'Детектив', 'Краткое описание жанра Детектив', 'Полное описание жанра Детектив', 3),
(9, 'Детская литература', 'Краткое описание жанра Детское', 'Полное описание жанра Детское', 7),
(10, 'Любовные романы', 'Краткое описание жанра Любовные романы', 'Полное описание жанра Любовные романы', 4),
(11, 'Биография', 'Краткое описание жанра Биография', 'Полное описание жанра Биография', 3),
(12, 'Мемуары', 'Краткое описание жанра Мемуары', 'Полное описание жанра Мемуары', 5),
(13, 'Фантастика', 'Краткое описание жанра Фантастика', 'Полное описание жанра Фантастика', 1),
(14, 'Приключения', 'Краткое описание жанра Приключения', 'Полное описание жанра Приключения', 1);

-- --------------------------------------------------------

--
-- Структура таблицы `categorygoods`
--

CREATE TABLE IF NOT EXISTS `categorygoods` (
...
--
-- Дамп данных таблицы `categorygoods`
--

INSERT INTO `categorygoods` (`category_id`, `goods_id`) VALUES
(2, 1),
(13, 1),
(1, 2),
(5, 3),
...
CREATE TABLE IF NOT EXISTS `goods` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `name_book` varchar(70) NOT NULL,
  `brief_description` text NOT NULL,
  `full_description` text NOT NULL,
  `activ` int(11) NOT NULL,
  `availability` int(11) NOT NULL,
  `availability_order` int(11) NOT NULL,
  PRIMARY KEY (`Id`)
...
INSERT INTO `goods` (`Id`, `name_book`, `brief_description`, `full_description`, `activ`, `availability`, `availability_order`) VALUES
(1, 'Клан', 'Играть, чтобы жить', 'полное описание книги Клан', 2, 10, 100),
(2, 'Загадки Вселенной', 'Все возвращается на круги своя', 'Астролет “Луч” летел в пятьдесят седьмом квартале Алкивиада, где датчики зафиксировали жесткое излучение. Это был один из самых мощных исследовательских звездолетов', 6, 27, 47),
(3, 'Шаг к цели', 'Краткое описание книги Шаг к цели', 'Полное описание книги Шаг к цели', 2, 10, 20),
(4, 'Лорд, который влюбился', 'Краткое описание книги Лорд, который влюбился', 'Полное описание книги Лорд, который влюбился', 3, 14, 30),
(5, 'Вредная ведьма для дракона', 'Краткое описание книги Вредная ведьма для дракона', 'Полное описание книги Вредная ведьма для дракона', 5, 7, 10),
(6, 'Академия надежды', 'Краткое описание книги Академия надежды', 'Полное описание книги Академия надежды', 4, 11, 24),
(7, 'Звезды зовут', 'Жилибыли король и королева', 'Жилибыли король и королева, они много лет мечтали получить ребенка. И вот у них появилась маленькая дочка…» — Подождите, пожалуйста, 902, я хочу спросить! Откуда король и королева получили свою маленькую дочку?', 1, 3, 45),
(8, 'Лед и зеркало', 'Лед хрустел у нее под ногами', 'Лед хрустел у нее под ногами — оглушительно громко в неподвижном безмолвии. Резкое солнце Трина играло на гранях бесчисленных ледяных кристаллов, и всюду плясали радуги. Она была слишком измучена, чтобы по достоинству оценить представление… но, черт, это было красиво! ', 1, 3, 45),
(9, 'Властелин колец', 'Моя прелесть!', 'Хоббит несет кольцо', 0, 8, 14),
(10, 'Приключения Шерлока Холмса', 'Бейкер Стрит, 221Б', 'Классика дедуктивного метода', 1, 7, 3),
(11, 'Драконье проклятие', 'Кто ж знал, что подменить сестру на смене означает смертельную опасность? Уж точно не я.', 'Кто ж знал, что подменить сестру на смене означает смертельную опасность? Уж точно не я.', 1, 9, 37),
(12, 'Унесенные ветром', 'Увлекательное по сюжету, остросоциальное произведение, основной проблемой которого является судьба человеческих ценностей в мире куплипродажи ', 'Действие книги происходит в один из наиболее сложных периодов в истории США и охватывает годы Гражданской войны (1861–1865) и последующей за ней Реконструкции.', 1, 0, 0),
(13, 'Она и Он', 'Зарубежная классика', 'Мадемуазель Терезе Жак Дорогая Тереза, – вы ведь позволили мне не называть вас «мадемуазель», – сообщаю вам новость, важную для всего «артистического круга», по выражению Бернара', 1, 0, 0),
(14, 'Мантисса', 'Зарубежная классика', 'Тогда, тщательно исследовав свое " Я", я понял, что могу вообразить, что у меня нет тела, что внешнего мира не существует, и не существует места, где я нахожусь, но, несмотря на это, я не могу вообразить, что я не существую', 1, 10, 70),
(15, 'Золотой охотник', 'Майкону Фраю, который показал, как это может быть сделано', 'К часу ночи он пришел к выводу, что Морфей к нему не торопится. По крайней мере, пока. Он перекатился на бок и, опираясь на левый локоть, правой рукой нащупал цепочку маленькой ночной лампы. ', 1, 0, 13),
(16, 'Ключ к разгадке', 'Классический детектив', 'Покинув Викторию точно по расписанию, в 4.15, поезд задержался у Трех Мостов, и Джон Лексман понял, что все его планы сорвутся. Правда, ему повезло — он успел пересесть в пригородный поезд до Бестон Трейси, но, сойдя с него, с огорчением убедился, что почтовая линейка — единственный вид транспорта', 1, 5, 15),
(17, 'Про войны', 'Детская образовательная литература', 'Очерки по истории возникновения войн, об их характере, о стратегии и тактике, о вооруженных силах, о славных подвигах советских солдат во время Великой Отечественной войны.', 1, 4, 111),
(18, 'Звездный зверь', 'Знаете стаpую детскую сказку о том, как злой кpокодил пpоглотил в небе Солнце?', 'Так вот: это непpавда. Глотал он вовсе не Солнце, да и не кpокодил это был, а чеpное бесплотное звездное чудовище, пpишедшее из невообpазимо далеких туманных пpостpанств.', 1, 4, 123),
(19, 'Катя в Игрушечном городе', 'В шкафу, на самой верхней полке, за стеклом, жила маленькая игрушечная девочка.', 'А ещё там жили хрустальные бокалы и рюмки. Они только и знали, что дрожали за свою красоту. «Дзинь! Сгинь!» — звенели они, когда внизу ктонибудь топал. Иногда стеклянная стена отодвигалась', 1, 3, 14),
(20, 'Лесной холм', 'Юркие ящерицы бегали вверх и вниз по истрескавшемуся корявому стволу старого дерева.', 'Они отлично понимали друг друга, потому что все говорили на одном языке — поящеричьи. — Нет, вы послушайте только, как шумит и гудит наш старый лесной холм, сказала одна из ящериц', 1, 24, 15),
(21, 'Люсьен Левен', 'Однажды человек, страдавший лихорадкой, принял хину.', 'Он еще держал стакан в руке и корчил гримасу от горечи; взглянув в зеркало, он увидел в нем свое бледное, даже слегка позеленевшее лицо. Быстро отставив стакан, он кинулся к зеркалу, чтобы его разбить. Такова, пожалуй, будет участь этих томов.', 1, 32, 55),
(22, 'Посещение', 'Она позвонила, чтобы договориться о посещении.', 'Сначала молодой человек воспротивился и ответил: — Нет, спасибо, нет, очень жаль, я все понимаю, но — нет. Однако вслед за тем на другом конце провода он услышал ее молчание — полное отсутствие каких бы то ни было звуков, только скорбь', 1, 22, 44),
(23, 'Сокровище', 'Ричард Харенгер был счастливым человеком', 'Что бы там ни говорили пессимисты со времен Екклезиаста, не так уж трудно найти счастливого человека в нашем несчастливом мире; но Ричард Харенгер знал, что он счастлив, а это действительно редкая вещь. ', 1, 11, 33),
(24, 'Гений. История человека, открывшего миру хемингуэя и фицджеральда', 'Моему другу Карлосу Бэкеруи моим родителям Барбаре и Ричарду Берг', 'Он пробирался через заросли небрежности, Как света всплеск, как блеск среди теней, И Дух его искал во мраке Истину, Но, как и Пастор, так и не нашел. ', 1, 22, 22),
(25, 'Стамбул. Город воспоминаний', 'Моему отцу', 'Лишь тот пейзаж красив, что навевает грусть.', 1, 33, 54),
(26, 'История о призраке, рассказанн', '— Хорошо, если хотите, я расскажу вам об одном случае, — произнесла она со своего места в темном углу', '— И, что важно, расскажу вкратце, без прикрас, то есть не вдаваясь в несущественные детали. Вы же знаете, рассказчики никогда так не поступают. — Женщина рассмеялась.', 1, 44, 45),
(27, 'Серая смерть', 'Человек сидел в пилотском кресле в неестественной, судорожной позе.', 'Его руки лежали на штурвале боевого самолета, но он, казалось, не хотел за него держаться. Лицо, которому вздутый летный шлем с опущенным черным стеклом придавал вид какогото насекомого, выглядело напряженным и бледным. ', 1, 42, 34),
(28, 'Раффлс, взломщик-любитель', 'Раффлс известен как виртуозный взломщик и грабитель, для которого не существует замков и преград', 'Он предусмотрителен и умен, его почти невозможно просчитать А еще он отлично играет в крикет', 1, 77, 43),
(29, 'пума для барса или божественные махинации', 'Добиться признания статуса независимой одиночки – совсем не значит стать свободной от обязательств и проблем. ', 'Но стоит ли и дальше всеми зубами и когтями пытаться отстоять свою независимость и свободу или всётаки можно довериться этому нежному Снежному?', 1, 11, 23),
(30, 'Пронзенное сердце', 'Странная смерть Элен Инглворт потрясла маленький городок', 'Когда же обнаружили, что её сердце проткнуто спицей, подозрения пали на доктора Лэмсона, которому покойная по непонятным причинам завещала большую сумму денег…', 1, 0, 32);
...
--
-- Ограничения внешнего ключа таблицы `categorygoods`
--
ALTER TABLE `categorygoods`
  ADD CONSTRAINT `categorygoods_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `categorygoods_ibfk_2` FOREIGN KEY (`goods_id`) REFERENCES `goods` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
--
...
('def', 'catalog-site', 'category', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'catalog-site', 'category', 'genre', 2, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'catalog-site', 'category', 'brief_description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'catalog-site', 'category', 'full_description', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'catalog-site', 'category', 'activ', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'catalog-site', 'categorygoods', 'category_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'catalog-site', 'categorygoods', 'goods_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'catalog-site', 'goods', 'Id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'catalog-site', 'goods', 'name_book', 2, NULL, 'NO', 'varchar', 70, 210, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(70)', '', '', 'select,insert,update,references', ''),
('def', 'catalog-site', 'goods', 'brief_description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'catalog-site', 'goods', 'full_description', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'catalog-site', 'goods', 'activ', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'catalog-site', 'goods', 'availability', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'catalog-site', 'goods', 'availability_order', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
...
('BYTES_RECEIVED', '12429'),
('BYTES_SENT', '280779'),
('COM_ADMIN_COMMANDS', '135'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '15'),
('CREATED_TMP_DISK_TABLES', '61'),
('CREATED_TMP_FILES', '5'),
('CREATED_TMP_TABLES', '222'),
('DELAYED_ERRORS', '0'),
...
('HANDLER_READ_LAST', '1'),
('HANDLER_READ_NEXT', '378'),
('HANDLER_READ_PREV', '38'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2494'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2225'),
('INNODB_BUFFER_POOL_PAGES_DATA', '374'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '21'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7818'),
('INNODB_BUFFER_POOL_PAGES_MISC', '0'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '5404'),
('INNODB_BUFFER_POOL_READS', '375'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '57'),
('INNODB_DATA_FSYNCS', '25'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '10424320'),
('INNODB_DATA_READS', '513'),
('INNODB_DATA_WRITES', '41'),
...
('INNODB_OS_LOG_WRITTEN', '7168'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '0'),
('INNODB_PAGES_READ', '374'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '1105'),
('UPTIME_SINCE_FLUSH_STATUS', '1105');
...
('PID_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\DESKTOP-UD5IEDO.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'utf8_general_ci'),
('GENERAL_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\DESKTOP-UD5IEDO.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'Z:\\usr\\local\\mysql-5.5\\data\\DESKTOP-UD5IEDO.err'),
...
('SLOW_QUERY_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\DESKTOP-UD5IEDO-slow.log'),
...
('def', 'catalog-site', 'PRIMARY', 'def', 'catalog-site', 'category', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'catalog-site', 'PRIMARY', 'def', 'catalog-site', 'categorygoods', 'category_id', 1, NULL, NULL, NULL, NULL),
('def', 'catalog-site', 'PRIMARY', 'def', 'catalog-site', 'categorygoods', 'goods_id', 2, NULL, NULL, NULL, NULL),
('def', 'catalog-site', 'categorygoods_ibfk_1', 'def', 'catalog-site', 'categorygoods', 'category_id', 1, 1, 'catalog-site', 'category', 'id'),
('def', 'catalog-site', 'categorygoods_ibfk_2', 'def', 'catalog-site', 'categorygoods', 'goods_id', 1, 1, 'catalog-site', 'goods', 'Id'),
('def', 'catalog-site', 'PRIMARY', 'def', 'catalog-site', 'goods', 'Id', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-03-27 20:14:13', '2020-03-27 20:14:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-03-27 20:14:13', '2020-03-27 20:14:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-03-27 20:14:13', '2020-03-27 20:14:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-03-27 20:14:13', '2020-03-27 20:14:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-03-27 20:14:13', '2020-03-27 20:14:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-03-27 20:14:13', '2020-03-27 20:14:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-03-27 20:14:13', '2020-03-27 20:14:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-03-27 20:14:13', '2020-03-27 20:14:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-03-27 20:14:13', '2020-03-27 20:14:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2020-03-27 20:14:13', NULL, NULL, NULL, '', '', NULL),
('def', 'catalog-site', 'category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 14, 1170, 16384, NULL, 0, 0, '2020-02-18 17:01:01', NULL, NULL, NULL, '', '', NULL),
('def', 'catalog-site', 'categorygoods', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 431, 16384, NULL, 16384, 0, '2020-02-19 03:08:21', NULL, NULL, NULL, '', '', NULL),
('def', 'catalog-site', 'goods', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 30, 546, 16384, NULL, 0, 0, '2020-02-18 17:21:13', NULL, NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2012-05-15 12:23:04', '2020-03-26 10:27:49', '2012-05-15 12:23:07', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-05-15 12:23:05', '2020-03-05 10:27:08', NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 79, 316, 281474976710655, 2048, 0, '2012-05-15 12:23:04', '2020-02-19 15:23:43', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_designer_coords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 40, 120, 281474976710655, 4096, 0, '2012-06-11 22:55:25', '2020-02-19 05:41:46', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_recent', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 140, 140, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2020-03-20 11:03:55', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 56, 281474976710655, 9216, 56, '2012-06-11 22:55:25', '2020-02-19 04:58:17', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_table_uiprefs', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 52, 144, 281474976710655, 7168, 92, '2012-06-11 22:55:25', '2020-02-19 12:14:29', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_userconfig', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 56, 56, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2020-02-19 04:11:31', NULL, NULL, '', '', NULL);
...
(14, 'root', 'localhost:57280', 'catalog-site', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(13, 'root', 'localhost:57279', NULL, 'Sleep', 3, '', NULL),
(1, 'root', 'localhost:51327', 'catalog-site', 'Sleep', 1, '', NULL);
...
('def', 'catalog-site', 'categorygoods_ibfk_1', 'def', 'catalog-site', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'categorygoods', 'category'),
('def', 'catalog-site', 'categorygoods_ibfk_2', 'def', 'catalog-site', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'categorygoods', 'goods');
...
('def', 'catalog-site', 'utf8', 'utf8_general_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '5488'),
('INNODB_BUFFER_POOL_READS', '375'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '57'),
('INNODB_DATA_FSYNCS', '25'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '1107'),
('UPTIME_SINCE_FLUSH_STATUS', '1107');
...
('def', 'catalog-site', 'category', 0, 'catalog-site', 'PRIMARY', 1, 'id', 'A', 14, NULL, NULL, '', 'BTREE', '', ''),
('def', 'catalog-site', 'categorygoods', 0, 'catalog-site', 'PRIMARY', 1, 'category_id', 'A', 38, NULL, NULL, '', 'BTREE', '', ''),
('def', 'catalog-site', 'categorygoods', 0, 'catalog-site', 'PRIMARY', 2, 'goods_id', 'A', 38, NULL, NULL, '', 'BTREE', '', ''),
('def', 'catalog-site', 'categorygoods', 1, 'catalog-site', 'goods_id', 1, 'goods_id', 'A', 38, NULL, NULL, '', 'BTREE', '', ''),
('def', 'catalog-site', 'goods', 0, 'catalog-site', 'PRIMARY', 1, 'Id', 'A', 30, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'phpmyadmin', 'pma_designer_coords', 0, 'phpmyadmin', 'PRIMARY', 2, 'table_name', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'phpmyadmin', 'pma_table_uiprefs', 0, 'phpmyadmin', 'PRIMARY', 3, 'table_name', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-03-27 20:14:15', '2020-03-27 20:14:15', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-03-27 20:14:15', '2020-03-27 20:14:15', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-03-27 20:14:15', '2020-03-27 20:14:15', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-03-27 20:14:15', '2020-03-27 20:14:15', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-03-27 20:14:15', '2020-03-27 20:14:15', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-03-27 20:14:15', '2020-03-27 20:14:15', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-03-27 20:14:15', '2020-03-27 20:14:15', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-03-27 20:14:15', '2020-03-27 20:14:15', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-03-27 20:14:15', '2020-03-27 20:14:15', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2020-03-27 20:14:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'catalog-site', 'category', 'BASE TABLE', 'InnoDB', 10, 'Compact', 14, 1170, 16384, 0, 0, 6291456, 19, '2020-02-18 17:01:01', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'catalog-site', 'categorygoods', 'BASE TABLE', 'InnoDB', 10, 'Compact', 38, 431, 16384, 0, 16384, 6291456, NULL, '2020-02-19 03:08:21', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'catalog-site', 'goods', 'BASE TABLE', 'InnoDB', 10, 'Compact', 30, 546, 16384, 0, 0, 6291456, 37, '2020-02-18 17:21:13', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
...
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2012-05-15 12:23:04', '2020-03-26 10:27:49', '2012-05-15 12:23:07', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-05-15 12:23:05', '2020-03-05 10:27:08', NULL, 'utf8_general_ci', NULL, '', 'Events'),
...
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 79, 316, 281474976710655, 2048, 0, NULL, '2012-05-15 12:23:04', '2020-02-19 15:23:43', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'phpmyadmin', 'pma_designer_coords', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 40, 120, 281474976710655, 4096, 0, NULL, '2012-06-11 22:55:25', '2020-02-19 05:41:46', NULL, 'utf8_bin', NULL, '', 'Table coordinates for Designer'),
...
('def', 'phpmyadmin', 'pma_recent', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 140, 140, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2020-03-20 11:03:55', NULL, 'utf8_bin', NULL, '', 'Recently accessed tables'),
('def', 'phpmyadmin', 'pma_relation', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 56, 281474976710655, 9216, 56, NULL, '2012-06-11 22:55:25', '2020-02-19 04:58:17', NULL, 'utf8_bin', NULL, '', 'Relation table'),
...
('def', 'phpmyadmin', 'pma_table_uiprefs', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 52, 144, 281474976710655, 7168, 92, NULL, '2012-06-11 22:55:25', '2020-02-19 12:14:29', NULL, 'utf8_bin', NULL, '', 'Tables'' UI preferences'),
...
('def', 'phpmyadmin', 'pma_userconfig', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 56, 56, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2020-02-19 04:11:31', NULL, 'utf8_bin', NULL, '', 'User preferences storage for phpMyAdmin');
...
('def', 'catalog-site', 'PRIMARY', 'catalog-site', 'category', 'PRIMARY KEY'),
('def', 'catalog-site', 'PRIMARY', 'catalog-site', 'categorygoods', 'PRIMARY KEY'),
('def', 'catalog-site', 'categorygoods_ibfk_1', 'catalog-site', 'categorygoods', 'FOREIGN KEY'),
('def', 'catalog-site', 'categorygoods_ibfk_2', 'catalog-site', 'categorygoods', 'FOREIGN KEY'),
('def', 'catalog-site', 'PRIMARY', 'catalog-site', 'goods', 'PRIMARY KEY'),
...
('127.0.0.1', 'root', '*6A7A490FB9DC8C33C2B025A91737077A7E9CC5E5', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', ''),
...
('catalog-site', 'category', 595, 128, 1, 1),
('catalog-site', 'goods', 588, 423, 1, 1),
('catalog-site', 'categorygoods', 256, 292, 1, 1);
...
('root', '[{"db":"catalog-site","table":"goods"},{"db":"catalog-site","table":"category"},{"db":"catalog-site","table":"categorygoods"}]');
...
--
-- Дамп данных таблицы `pma_table_uiprefs`
--

INSERT INTO `pma_table_uiprefs` (`username`, `db_name`, `table_name`, `prefs`, `last_update`) VALUES
('root', 'catalog-site', 'goods', '[]', '2020-02-19 12:14:29');
...
('root', '2020-02-19 04:11:31', '{"lang":"ru","ThemeDefault":"pmahomme"}');
